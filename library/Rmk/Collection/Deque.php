 ...
 * интерфейс очереди объектов Queue и добавляет дополнительную 
 * функциональность. Функциональность двунаправленной очереди объектов 
 * подразумевает работу с очередью с обеих сторон.
 * 
 * @category Rmk
