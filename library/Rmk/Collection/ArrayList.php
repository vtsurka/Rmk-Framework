 ...
 * функциональности от AbstractCollection. Список объектов 
 * поддерживает последовательный порядок индексов при изменении своей структуры.
 * Список объектов поддерживает любые типы данных для значений.
 *
 * @category Rmk
