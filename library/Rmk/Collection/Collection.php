 ...
 * множеством объектов. Он наследует интерфейсы Countable и Iterable, что 
 * позволяет получать количество объектов в коллекции и выполнять обход и 
 * применение пользовательской функции для каждого объекта коллекции. Интерфейс 
 * коллекции подразумевает, что в коллекции находятся объекты одного типа.
 *
 * @category Rmk
